...
t = tiledlayout(length(imFiles), totalMethods+2, TileSpacing="tight", Padding="compact");
cnt = 1;
...
exportgraphics(fh, 'assets/crack_segmentation.png')
...
exportgraphics(ax, 'assets/crack_output.png')
